...
#define UAVCAN_PROTOCOL_PARAM_EXECUTEOPCODE_ID              10U
#define UAVCAN_PROTOCOL_PARAM_EXECUTEOPCODE_SIGNATURE       0xa7b622f939d1a466ULL
#define UAVCAN_PROTOCOL_PARAM_EXECUTEOPCODE_REQUEST_SIZE    7U
#define UAVCAN_PROTOCOL_PARAM_EXECUTEOPCODE_RESPONSE_SIZE   7U
...
static inline uint8_t uavcanProtocolParamExecuteOpcodeDecode(const CanardRxTransfer* transfer)
{
    uint8_t opcode;
