...
#define UAVCAN_EQUIPMENT_ACTUATOR_COMMAND_MESSAGE_SIZE              4U

#define UAVCAN_EQUIPMENT_ACTUATOR_STATUS_ID                         1011U
#define UAVCAN_EQUIPMENT_ACTUATOR_STATUS_SIGNATURE                  0x5e9bba44faf1ea04ULL
#define UAVCAN_EQUIPMENT_ACTUATOR_STATUS_MESSAGE_SIZE               8U

#define NUMBER_OF_ACTUATOR_ARRAY_COMMANDS                           16U
#define UAVCAN_EQUIPMENT_ACTUATOR_ARRAY_COMMAND_ID                  1010U
#define UAVCAN_EQUIPMENT_ACTUATOR_ARRAY_COMMAND_SIGNATURE           0xd8a7486238ec3af3ULL
#define UAVCAN_EQUIPMENT_ACTUATOR_ARRAY_COMMAND_MESSAGE_SIZE        64U
...
static inline uint32_t dronecan_equipment_actuator_arraycommand_serialize(
    const ArrayCommand_t* const obj, uint8_t* const buffer, uint8_t num_cmds) {
