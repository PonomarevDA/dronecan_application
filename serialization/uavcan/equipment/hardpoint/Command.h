...
static inline int8_t dronecan_equipment_hardpoint_command_serialize(
    const HardpointCommand_t* const obj, uint8_t* const buffer, size_t* const inout_buffer_size_bytes) {
...
static inline int8_t dronecan_equipment_hardpoint_command_publish(const HardpointCommand_t* const obj,
