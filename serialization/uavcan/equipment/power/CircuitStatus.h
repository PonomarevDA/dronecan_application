...
static inline int8_t dronecan_equipment_power_circuit_status_serialize(
    const CircuitStatus_t* const obj, uint8_t* const buffer, size_t* const inout_buffer_size_bytes) {
...
static inline int8_t dronecan_equipment_circuit_status_publish(const CircuitStatus_t* const obj,
