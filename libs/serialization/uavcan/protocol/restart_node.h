...
#define UAVCAN_PROTOCOL_RESTART_NODE_ID             5U
#define UAVCAN_PROTOCOL_RESTART_NODE_SIGNATURE      0x569e05394a3017f0ULL
#define UAVCAN_PROTOCOL_RESTART_NODE_RESPONSE_SIZE  1U
